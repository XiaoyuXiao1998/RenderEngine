...
int main()
{
    ...
    Shader* SkyboxShader = new Shader("../../../shader/CornellBox.vert", "../../../shader/CornellBox.frag");
  ...
  //  ourModel->loadPRTparameters("../../../assets//cubemap/CornellBox", *BallShader);
    ...
    //reference :  3.594112
    scene.setTestAreaLight(glm::vec3(1, 1, 1), glm::vec3(1, 1, 1), true, glm::vec3(0, 3.594, 0.f), 1, 1);
