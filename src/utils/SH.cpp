#include"../../include/utils/SH.h"
	...
	void SH::RotateSH_L2(const glm::mat3& R, glm::mat3& SHcoefficients) {
		...
		//[1][1] [1][2] [2][0] [2][1] [2][2]
		//0 k0 0 -k0 k1
		Ax[0] = SHcoefficients[1][2] * K0 - SHcoefficients[2][1] * K0 + SHcoefficients[2][2] * K1;
		//k0 0 k2 -k0 k0
		Ax[1] = SHcoefficients[1][1] * K0 + SHcoefficients[2][0] * K2 - SHcoefficients[2][1] * K0 + SHcoefficients[2][2] * K0;
		//k1 0 0 0 0
		Ax[2] = SHcoefficients[1][1] * K1;
		//0 0 0 k1 0
		Ax[3] = SHcoefficients[2][1] * K1;
		//0 k1 0 0 0
		Ax[4] = SHcoefficients[1][2] * K1;
		...
		for (int i = 0; i < 5; i++) {
			...
			S[i][1] = EvalSH(1, i - 1, R * n1);
			S[i][2] = EvalSH(1, i - 1, R * n2);
			S[i][3] = EvalSH(1, i - 1, R * n3);
			S[i][4] = EvalSH(1, i - 1, R * n4);
		}
